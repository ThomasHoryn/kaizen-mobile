...
/**
 * Criteria class for the {@link com.kaizenmobile.domain.AppUser} entity. This class is used
 * in {@link com.kaizenmobile.web.rest.AppUserResource} to receive all the possible filtering options from
...
public class AppUserCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tenantId, internalUserId, distinct);
    }
